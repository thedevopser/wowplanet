...
final readonly class HealthReport
{
     ...
     *     queue: array{status: string, issue: string|null, detail?: string, queue?: string, pending?: int, delayed?: int, reserved?: int, current?: array{job_id: string, started_at: int}|null, failed?: list<array{uuid: string, queue: string, job: string, exception: string, failed_at: string}>},
    ...
    public function snapshot(): array
    {
        return [
            ...
            'queue' => $this->guard('Queue', $this->queueState->snapshot(...)),
